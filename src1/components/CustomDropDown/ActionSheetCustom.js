/**
 * @author [Rahul Rajput]
 * @email [rahul.rajpoot@xebia.com]
 * @create date 2021-05-26 15:50:49
 * @modify date 2021-05-26 15:51:05
 * @desc [Blue cross icons changed]
 */
 ...
 // Close Icon changed
//  import Close from '../../../../assets/icons/blue-cross.svg'; this is the new code 
 ...
 class ActionSheet extends React.Component {
   ...
   _renderTitle() {
     ...
     return (
       <View style={[styles.titleBox, styles.titleBox2]}>
         {React.isValidElement(title) ? (
           title
         ) : (
           <Text style={[styles.titleText, styles.titleStyle]}>{title}</Text>
         )}
         {/* <TouchableHighlight
           onPress={() => this.hide(0)}
           activeOpacity={0.5}
   ...
   _createButton(title, index) {
     ...
     const buttonBoxStyle =
       cancelButtonIndex === index ? styles.cancelButtonBox : [styles.buttonBox, styles.optionStyle];
     return (
       <TouchableHighlight
         key={index}
         activeOpacity={1}
         ...
         {React.isValidElement(title) ? (
           ...
           <Text style={[styles.buttonText, {color: fontColor}, cancelButtonIndex !== index && styles.optionTextStyle]}>
             {title.title}
           </Text>
         )}
       </TouchableHighlight>
       ...
       <Modal
         ...
         <View style={[styles.wrapper]}>
           ...
           <Animated.View
             ...
             {this.props.cancelButtonIndex ? this._renderCancelButton(): null}
           </Animated.View>
         </View>
       </Modal>
     );
