...
import {defaultStyles} from './NewPickerStyle';
...
export default class RNPickerSelect extends PureComponent {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    const itemsChanged = prevState.items !== items;
      ...
      <View pointerEvents="box-only" style={containerStyle}>
        <TextInput
          ...
          style={[
            ...
            // {fontFamily: SceneUtils.whitney_semibold, fontSize: 14, color: SceneUtils.text_color},
          ]}
          value={
      ...
      <View style={[defaultStyles.viewContainer, style.viewContainer]}>
        <Picker
          style={[
            ...
            style.inputAndroid,
            this.getPlaceholderStyle(),
            {backgroundColor: 'transparent', minWidth: 80}
          ]}
