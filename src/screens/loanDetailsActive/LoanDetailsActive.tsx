...
const LoanDetailsActive = ({ route, navigation }: any) => {
    ...
    // ==========================================
    // SELECT OVERDUE EMI AUTOMATICALLY
    // ==========================================
        ...
        try {
            ...
            navigation.navigate(
                "WebViewScreen",
                {
                    ...
                    // VERY IMPORTANT
                    // This tells WebViewScreen that
                    // this WebView is being opened for payment.
                    fromPayment: true,
                }
            );
...
//         console.log("Payment Data:", { user_id, order_id });
//         const amount =
//             emiItem?.balance ||
//             emiItem?.emi_amount ||
//             emiPaymentDetails?.total_payable_amount;
...
//             return;
//         }
//         console.log("Payment Data:", { user_id, order_id, amount }); // Log the payment data for debugging
//         const url =
//             ENDPOINTS.PAY_URL +
//             `icici-upi-form/user_id/${user_id}/loan_id/${order_id}/amount/${amount}`;
//         console.log("Payment URL:", url); // Log the URL for debugging
